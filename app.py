...
df_0 = pd.read_csv('..\dados\srag_2019.csv', sep = ";", encoding='ISO-8859-1', on_bad_lines='skip', 
...
df_1 = pd.read_csv('..\dados\srag_2020.csv', sep = ";", encoding='ISO-8859-1', on_bad_lines='skip', 
        nrows = 790000, low_memory=False, dayfirst=True,
        parse_dates=['DT_NOTIFIC', 'DT_SIN_PRI', 'DT_NASC', 'DT_INTERNA', 'DT_COLETA', 'DT_PCR', 'DT_EVOLUCA', 
                     'DT_ENCERRA', 'DT_DIGITA'])
df_2 = pd.read_csv('..\dados\srag_2021.csv', sep = ";", encoding='ISO-8859-1', on_bad_lines='skip', 
        nrows = 790000, low_memory=False, dayfirst=True,
        parse_dates=['DT_NOTIFIC', 'DT_SIN_PRI', 'DT_NASC', 'DT_INTERNA', 'DT_COLETA', 'DT_PCR', 'DT_EVOLUCA', 
                     'DT_ENCERRA', 'DT_DIGITA'])
df_3 = pd.read_csv('..\dados\srag_2022.csv', sep = ";", encoding='ISO-8859-1', on_bad_lines='skip', 
        nrows = 790000, low_memory=False, dayfirst=True,
        parse_dates=['DT_NOTIFIC', 'DT_SIN_PRI', 'DT_NASC', 'DT_INTERNA', 'DT_COLETA', 'DT_PCR', 'DT_EVOLUCA', 
                     'DT_ENCERRA', 'DT_DIGITA'])
df_4 = pd.read_csv('..\dados\srag_2023.csv', sep = ";", encoding='ISO-8859-1', on_bad_lines='skip', 
        nrows = 790000, low_memory=False, dayfirst=True,
        parse_dates=['DT_NOTIFIC', 'DT_SIN_PRI', 'DT_NASC', 'DT_INTERNA', 'DT_COLETA', 'DT_PCR', 'DT_EVOLUCA', 
                     'DT_ENCERRA', 'DT_DIGITA'])
...
df_merged = pd.concat([df_0, df_1, df_2, df_3, df_4])
